...
struct batsman
 {
   char name[25];
   int runs,score,balls,toruns,tobal,fours,sixes;
     ...
     switch(choice)
      {
        ...
        case 1:
              ...
              pl1[plno].runs=(4*pl1[plno].fours)+(6*pl1[plno].sixes);
             ...
             plno--;
              ...
              printf("=================================================================\n");
               ...
               {   pl2[plno].econ=pl2[plno].runs/pl2[plno].overs;
                   printf(" %-15s %-14d %-13d %-11d %-11.2f\n\n",pl2[plno].name,pl2[plno].overs,pl2[plno].runs,pl2[plno].wkts,pl2[plno].econ);
               }
        ...
        case 3:
              ...
              printf("=================================================================\n");
               ...
               for(i=0;i<n;i++)
               {   pl2[i].econ=pl2[i].runs/pl2[i].overs;
                   printf(" %-15s %-14d %-13d %-11d %-11.2f\n\n\n",pl2[i].name,pl2[i].overs,pl2[i].runs,pl2[i].wkts,pl2[i].econ);
               }
        ...
        case 4: pl3.max_run=0,pl4.max_w=0,pl3.max_four=0,pl3.max_six=0;
                ...
                for(i=0;i<m;i++)
                  { 
                     ...
                     if(pl4.max_w<pl2[i].wkts)
                      {
                      pl4.max_w=pl2[i].wkts;
                      }
                  }
